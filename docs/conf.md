...
The file is divided into sections, with the name of each section stored in square brackets, and pairs of key-value pairs under the square brackets. 
...
The three sections meta/global/custom store the paths to the necessary files for the analysis process.
